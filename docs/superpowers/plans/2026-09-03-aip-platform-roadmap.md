...
- [x] **Task 1.1 — ops-deploy-release** (order 1)
...
- [x] **Task 1.2 — ops-incident-troubleshooting** (order 2)
...
- [x] **Task 1.3 — ops-observability** (order 3)
...
- [x] **Task 2.1 — backend-testing** (plugin backend, order 3)
...
- [x] **Task 2.2 — frontend-testing** (plugin frontend, order 3)
...
- [x] **Task 3.1 — backend-code-review** (plugin backend, order 4)
...
- [x] **Task 3.2 — backend-refactor** (plugin backend, order 5)
...
- [x] **Task 3.3 — frontend-code-review** (plugin frontend, order 4)
...
- [x] **Task 3.4 — frontend-refactor** (plugin frontend, order 5)
...
- [x] **Task 4.1 — engineering-release-notes** (order 4)
...
- [x] **Task 4.2 — engineering-adr** (order 5)
...
- [x] **Task 4.3 — engineering-convention-enforce** (order 6)
...
- [x] **Task 5.1 — backend-api-contract** (plugin backend, order 8)
...
- [x] **Task 5.2 — oltp-database-implement** (plugin oltp-database, order 2)
...
- [x] **Task 5.3 — olap-warehouse-implement** (plugin olap-warehouse, order 2)
...
- [x] **Task 6.1 — .gitattributes + chuẩn hoá LF** (index đã LF; chỉ cần .gitattributes)
...
- [x] **Task 6.2 — _cowork.json** (8 → 29 skill; pack ra 29 zip)
...
- [x] **Task 6.3 — Dọn MCP legacy** (điều tra: KHÔNG ở repo — nằm ở config Claude client của user; hướng dẫn user gỡ, không sửa ngoài repo)
